...
PyMethodDef LinkBaseExtensionPy::Methods[] = {
    {"configLinkProperty",
        reinterpret_cast<PyCFunction>(reinterpret_cast<void (*) (void)>( staticCallback_configLinkProperty )),
...
PyObject *LinkBaseExtensionPy::PyMake(struct _typeobject *, PyObject *, PyObject *)  // Python wrapper
{
...
{
    return std::string("<LinkBaseExtension object>");
}
