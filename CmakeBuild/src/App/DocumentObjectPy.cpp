...
PyMethodDef DocumentObjectPy::Methods[] = {
    ...
    {"evalExpression",
        reinterpret_cast<PyCFunction>(reinterpret_cast<void (*) (void)>( staticCallback_evalExpression )),
    ...
    {"getSubObject",
        reinterpret_cast<PyCFunction>(reinterpret_cast<void (*) (void)>( staticCallback_getSubObject )),
    ...
    {"getLinkedObject",
        reinterpret_cast<PyCFunction>(reinterpret_cast<void (*) (void)>( staticCallback_getLinkedObject )),
        METH_VARARGS|METH_KEYWORDS,
