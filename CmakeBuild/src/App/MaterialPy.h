...
public:
    ...
    Py::Tuple getAmbientColor() const;
    ...
    Py::Tuple getDiffuseColor() const;
    ...
    Py::Tuple getEmissiveColor() const;
    ...
    Py::Tuple getSpecularColor() const;
    ...
    Py::Float getTransparency() const;
