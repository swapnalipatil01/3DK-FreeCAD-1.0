...
PyMethodDef CommandPy::Methods[] = {
    {"get",
        reinterpret_cast<PyCFunction>(reinterpret_cast<void (*) (void)>( staticCallback_get )),
        METH_VARARGS|METH_STATIC,
        "get(name) -> Gui.Command or None\n\nGet a given command by name or None if it doesn't exist.\n\nname : str\n    Command name."
    },
    {"update",
        reinterpret_cast<PyCFunction>(reinterpret_cast<void (*) (void)>( staticCallback_update )),
        METH_VARARGS|METH_STATIC,
        "update() -> None\n\nUpdate active status of all commands."
    },
    {"listAll",
        reinterpret_cast<PyCFunction>(reinterpret_cast<void (*) (void)>( staticCallback_listAll )),
        METH_VARARGS|METH_STATIC,
        "listAll() -> list of str\n\nReturns the name of all commands."
    },
    {"listByShortcut",
        reinterpret_cast<PyCFunction>(reinterpret_cast<void (*) (void)>( staticCallback_listByShortcut )),
        METH_VARARGS|METH_STATIC,
    ...
    {"createCustomCommand",
        reinterpret_cast<PyCFunction>(reinterpret_cast<void (*) (void)>( staticCallback_createCustomCommand )),
    ...
    {"removeCustomCommand",
        reinterpret_cast<PyCFunction>(reinterpret_cast<void (*) (void)>( staticCallback_removeCustomCommand )),
        METH_VARARGS|METH_STATIC,
    ...
    {"findCustomCommand",
        reinterpret_cast<PyCFunction>(reinterpret_cast<void (*) (void)>( staticCallback_findCustomCommand )),
        METH_VARARGS|METH_STATIC,
