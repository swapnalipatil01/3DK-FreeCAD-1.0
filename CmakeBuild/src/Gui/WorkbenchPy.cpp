...
// This File is normally built as an include in WorkbenchPyImp.cpp! It's not intended to be in a project!
...
PyMethodDef WorkbenchPy::Methods[] = {
    {"name",
        reinterpret_cast<PyCFunction>( staticCallback_name ),
        METH_VARARGS,
        "Return the workbench name"
    },
    {"activate",
        reinterpret_cast<PyCFunction>( staticCallback_activate ),
        METH_VARARGS,
    ...
    {"getToolbarItems",
        reinterpret_cast<PyCFunction>( staticCallback_getToolbarItems ),
        METH_VARARGS,
    ...
    {"reloadActive",
        reinterpret_cast<PyCFunction>(reinterpret_cast<void (*) (void)>( staticCallback_reloadActive )),
...
PyObject * WorkbenchPy::staticCallback_activate (PyObject *self, PyObject *args)
{
    // make sure that not a null pointer is passed
    if (!self) {
        PyErr_SetString(PyExc_TypeError, "descriptor 'activate' of 'Gui.Workbench' object needs an argument");
        return nullptr;
    }
...
// has to be implemented in WorkbenchPyImp.cpp
PyObject * WorkbenchPy::staticCallback_listToolbars (PyObject *self, PyObject *args)
{
    // make sure that not a null pointer is passed
    if (!self) {
    ...
    try { // catches all exceptions coming up from c++ and generate a python exception
        PyObject* ret = static_cast<WorkbenchPy*>(self)->listToolbars(args);
        if (ret != 0)
            static_cast<WorkbenchPy*>(self)->startNotify();
        return ret;
    } // Please sync the following catch implementation with PY_CATCH
...
// getToolbarItems() callback and implementer
// PyObject*  WorkbenchPy::getToolbarItems(PyObject *args){};
// has to be implemented in WorkbenchPyImp.cpp
PyObject * WorkbenchPy::staticCallback_getToolbarItems (PyObject *self, PyObject *args)
{
    // make sure that not a null pointer is passed
    if (!self) {
        PyErr_SetString(PyExc_TypeError, "descriptor 'getToolbarItems' of 'Gui.Workbench' object needs an argument");
        return nullptr;
    }
    ...
    try { // catches all exceptions coming up from c++ and generate a python exception
        PyObject* ret = static_cast<WorkbenchPy*>(self)->getToolbarItems(args);
        if (ret != 0)
            static_cast<WorkbenchPy*>(self)->startNotify();
        return ret;
    } // Please sync the following catch implementation with PY_CATCH
...
// has to be implemented in WorkbenchPyImp.cpp
PyObject * WorkbenchPy::staticCallback_listCommandbars (PyObject *self, PyObject *args)
{
    // make sure that not a null pointer is passed
    if (!self) {
        PyErr_SetString(PyExc_TypeError, "descriptor 'listCommandbars' of 'Gui.Workbench' object needs an argument");
        return nullptr;
    }
    ...
    try { // catches all exceptions coming up from c++ and generate a python exception
        PyObject* ret = static_cast<WorkbenchPy*>(self)->listCommandbars(args);
        if (ret != 0)
            static_cast<WorkbenchPy*>(self)->startNotify();
        return ret;
    } // Please sync the following catch implementation with PY_CATCH
...
// has to be implemented in WorkbenchPyImp.cpp
PyObject * WorkbenchPy::staticCallback_listMenus (PyObject *self, PyObject *args)
{
    // make sure that not a null pointer is passed
    if (!self) {
        PyErr_SetString(PyExc_TypeError, "descriptor 'listMenus' of 'Gui.Workbench' object needs an argument");
        return nullptr;
    }
    ...
    try { // catches all exceptions coming up from c++ and generate a python exception
        PyObject* ret = static_cast<WorkbenchPy*>(self)->listMenus(args);
        if (ret != 0)
            static_cast<WorkbenchPy*>(self)->startNotify();
        return ret;
    } // Please sync the following catch implementation with PY_CATCH
...
// reloadActive() callback and implementer
// PyObject*  WorkbenchPy::reloadActive(PyObject *args){};
// has to be implemented in WorkbenchPyImp.cpp
PyObject * WorkbenchPy::staticCallback_reloadActive (PyObject *self, PyObject *args)
{
    try { // catches all exceptions coming up from c++ and generate a python exception
        (void)self;
        PyObject* ret = WorkbenchPy::reloadActive(args);
        return ret;
    } // Please sync the following catch implementation with PY_CATCH
    catch(Base::Exception &e)
    {
