...
PyMethodDef ViewProviderPy::Methods[] = {
    ...
    {"canDropObject",
        reinterpret_cast<PyCFunction>(reinterpret_cast<void (*) (void)>( staticCallback_canDropObject )),
    ...
    {"dropObject",
        reinterpret_cast<PyCFunction>(reinterpret_cast<void (*) (void)>( staticCallback_dropObject )),
        METH_VARARGS|METH_KEYWORDS,
