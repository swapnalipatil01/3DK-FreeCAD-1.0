...
#ifndef SKETCHER_EXTERNALGEOMETRYFACADEPY_H
#define SKETCHER_EXTERNALGEOMETRYFACADEPY_H
...
//===========================================================================
// ExternalGeometryFacadePy - Python wrapper
//===========================================================================

/** The python export class for ExternalGeometryFacade
 */
class SketcherExport ExternalGeometryFacadePy : public Base::BaseClassPy
{
protected:
...
public:
    ...
    using PointerType = ExternalGeometryFacade*;
    ...
    ExternalGeometryFacade *getExternalGeometryFacadePtr() const;

};

}  //namespace Sketcher

#endif  // SKETCHER_EXTERNALGEOMETRYFACADEPY_H
