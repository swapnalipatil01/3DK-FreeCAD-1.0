...
#ifndef PART_GEOMETRYSTRINGEXTENSIONPY_H
#define PART_GEOMETRYSTRINGEXTENSIONPY_H
...
//===========================================================================
// GeometryStringExtensionPy - Python wrapper
//===========================================================================

/** The python export class for GeometryStringExtension
 */
class PartExport GeometryStringExtensionPy : public Part::GeometryExtensionPy
{
protected:
...
public:
    ...
    using PointerType = GeometryStringExtension*;
    ...
    GeometryStringExtension *getGeometryStringExtensionPtr() const;

};

}  //namespace Part

#endif  // PART_GEOMETRYSTRINGEXTENSIONPY_H
