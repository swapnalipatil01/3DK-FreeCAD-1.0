...
#ifndef PART_ARCOFHYPERBOLA2DPY_H
#define PART_ARCOFHYPERBOLA2DPY_H
...
//===========================================================================
// ArcOfHyperbola2dPy - Python wrapper
//===========================================================================

/** The python export class for Geom2dArcOfHyperbola
 */
class PartExport ArcOfHyperbola2dPy : public Part::ArcOfConic2dPy
{
protected:
    ~ArcOfHyperbola2dPy();
...
public:
    ...
    using PointerType = Geom2dArcOfHyperbola*;
    ...
    Geom2dArcOfHyperbola *getGeom2dArcOfHyperbolaPtr() const;

};

}  //namespace Part

#endif  // PART_ARCOFHYPERBOLA2DPY_H
