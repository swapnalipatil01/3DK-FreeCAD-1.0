...
#ifndef PART_ELLIPSE2DPY_H
#define PART_ELLIPSE2DPY_H
...
//===========================================================================
// Ellipse2dPy - Python wrapper
//===========================================================================

/** The python export class for Geom2dEllipse
 */
class PartExport Ellipse2dPy : public Part::Conic2dPy
{
protected:
    ~Ellipse2dPy();
...
public:
    ...
    using PointerType = Geom2dEllipse*;
    ...
    Geom2dEllipse *getGeom2dEllipsePtr() const;

};

}  //namespace Part

#endif  // PART_ELLIPSE2DPY_H
