...
PyMethodDef BSplineCurve2dPy::Methods[] = {
    ...
    {"getCardinalSplineTangents",
        reinterpret_cast<PyCFunction>(reinterpret_cast<void (*) (void)>( staticCallback_getCardinalSplineTangents )),
        METH_VARARGS|METH_KEYWORDS,
        "Compute the tangents for a Cardinal spline"
    },
    {"interpolate",
        reinterpret_cast<PyCFunction>(reinterpret_cast<void (*) (void)>( staticCallback_interpolate )),
        METH_VARARGS|METH_KEYWORDS,
...
{
    return std::string("<Geom2dBSplineCurve object>");
}
