...
#ifndef PART_GEOMETRYDOUBLEEXTENSIONPY_H
#define PART_GEOMETRYDOUBLEEXTENSIONPY_H
...
//===========================================================================
// GeometryDoubleExtensionPy - Python wrapper
//===========================================================================

/** The python export class for GeometryDoubleExtension
 */
class PartExport GeometryDoubleExtensionPy : public Part::GeometryExtensionPy
{
protected:
...
public:
    ...
    using PointerType = GeometryDoubleExtension*;
    ...
    GeometryDoubleExtension *getGeometryDoubleExtensionPtr() const;

};

}  //namespace Part

#endif  // PART_GEOMETRYDOUBLEEXTENSIONPY_H
