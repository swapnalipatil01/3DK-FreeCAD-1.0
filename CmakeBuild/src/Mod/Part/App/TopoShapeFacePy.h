...
public:
    ...
    //@{
    /// callback for the addWire() method
    static PyObject * staticCallback_addWire (PyObject *self, PyObject *args);
    /// implementer for the addWire() method
    PyObject*  addWire(PyObject *args);
    ...
    /// callback for the countNodes() method
    static PyObject * staticCallback_countNodes (PyObject *self, PyObject *args);
    /// implementer for the countNodes() method
    PyObject*  countNodes(PyObject *args);
    /// callback for the countTriangles() method
    static PyObject * staticCallback_countTriangles (PyObject *self, PyObject *args);
    /// implementer for the countTriangles() method
    PyObject*  countTriangles(PyObject *args);
    ...
    Py::Tuple getParameterRange() const;
