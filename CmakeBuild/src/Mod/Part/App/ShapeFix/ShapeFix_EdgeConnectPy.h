...
#ifndef PART_SHAPEFIX_EDGECONNECTPY_H
#define PART_SHAPEFIX_EDGECONNECTPY_H
...
//===========================================================================
// ShapeFix_EdgeConnectPy - Python wrapper
//===========================================================================

/** The python export class for ShapeFix_EdgeConnect
 */
class PartExport ShapeFix_EdgeConnectPy : public Base::PyObjectBase
{
protected:
    ~ShapeFix_EdgeConnectPy();
...
public:
    ShapeFix_EdgeConnectPy(ShapeFix_EdgeConnect *pcObject, PyTypeObject *T = &Type);
    static PyObject *PyMake(struct _typeobject *, PyObject *, PyObject *);
    virtual int PyInit(PyObject* args, PyObject*k);


    using PointerType = ShapeFix_EdgeConnect*;
    ...
    ShapeFix_EdgeConnect *getShapeFix_EdgeConnectPtr() const;

};

}  //namespace Part

#endif  // PART_SHAPEFIX_EDGECONNECTPY_H
