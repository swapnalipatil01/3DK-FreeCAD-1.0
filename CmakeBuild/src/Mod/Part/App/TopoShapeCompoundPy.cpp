...
// This File is normally built as an include in TopoShapeCompoundPyImp.cpp! It's not intended to be in a project!
...
PyMethodDef TopoShapeCompoundPy::Methods[] = {
    ...
    {"connectEdgesToWires",
        reinterpret_cast<PyCFunction>( staticCallback_connectEdgesToWires ),
        METH_VARARGS,
...
PyObject * TopoShapeCompoundPy::staticCallback_connectEdgesToWires (PyObject *self, PyObject *args)
{
    // make sure that not a null pointer is passed
    if (!self) {
        PyErr_SetString(PyExc_TypeError, "descriptor 'connectEdgesToWires' of 'Part.TopoShape' object needs an argument");
        return nullptr;
    }
...
//--------------------------------------------------------------------------
PyObject *TopoShapeCompoundPy::_repr()
{
...
//--------------------------------------------------------------------------
PyObject *TopoShapeCompoundPy::_getattr(const char *attr)			// __getattr__ function: note only need to handle new state
{
    try {
...
int TopoShapeCompoundPy::_setattr(const char *attr, PyObject *value) // __setattr__ function: note only need to handle new state
{
    try {
...
TopoShape *TopoShapeCompoundPy::getTopoShapePtr() const
{
