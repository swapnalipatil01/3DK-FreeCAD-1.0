...
#ifndef PART_CYLINDERPY_H
#define PART_CYLINDERPY_H
...
//===========================================================================
// CylinderPy - Python wrapper
//===========================================================================

/** The python export class for GeomCylinder
 */
class PartExport CylinderPy : public Part::GeometrySurfacePy
{
protected:
    ~CylinderPy();
...
public:
    ...
    using PointerType = GeomCylinder*;
    ...
    GeomCylinder *getGeomCylinderPtr() const;

};

}  //namespace Part

#endif  // PART_CYLINDERPY_H
