...
PyMethodDef GeometrySurfacePy::Methods[] = {
    ...
    {"toShell",
        reinterpret_cast<PyCFunction>(reinterpret_cast<void (*) (void)>( staticCallback_toShell )),
    ...
    {"projectPoint",
        reinterpret_cast<PyCFunction>(reinterpret_cast<void (*) (void)>( staticCallback_projectPoint )),
        METH_VARARGS|METH_KEYWORDS,
    ...
    {"toBSpline",
        reinterpret_cast<PyCFunction>(reinterpret_cast<void (*) (void)>( staticCallback_toBSpline )),
        METH_VARARGS|METH_KEYWORDS,
