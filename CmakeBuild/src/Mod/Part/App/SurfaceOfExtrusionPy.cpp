...
// This File is normally built as an include in SurfaceOfExtrusionPyImp.cpp! It's not intended to be in a project!
...
PyTypeObject SurfaceOfExtrusionPy::Type = {
    ...
    "Part.SurfaceOfExtrusion",     /*tp_name*/
...
PyObject * SurfaceOfExtrusionPy::staticCallback_getDirection (PyObject *self, void * /*closure*/)
{
    ...
    try {
        ...
        PyErr_SetString(Base::PyExc_FC_GeneralError, "Unknown exception while reading attribute 'Direction' of object 'GeomSurfaceOfExtrusion'");
        return nullptr;
    }
}
...
int SurfaceOfExtrusionPy::staticCallback_setDirection (PyObject *self, PyObject *value, void * /*closure*/)
{
    ...
    try {
        ...
        PyErr_SetString(Base::PyExc_FC_GeneralError, "Unknown exception while writing attribute 'Direction' of object 'GeomSurfaceOfExtrusion'");
        return -1;
    }
}
...
PyObject * SurfaceOfExtrusionPy::staticCallback_getBasisCurve (PyObject *self, void * /*closure*/)
{
    ...
    try {
        ...
        PyErr_SetString(Base::PyExc_FC_GeneralError, "Unknown exception while reading attribute 'BasisCurve' of object 'GeomSurfaceOfExtrusion'");
        return nullptr;
    }
}
...
int SurfaceOfExtrusionPy::staticCallback_setBasisCurve (PyObject *self, PyObject *value, void * /*closure*/)
{
    ...
    try {
        ...
        PyErr_SetString(Base::PyExc_FC_GeneralError, "Unknown exception while writing attribute 'BasisCurve' of object 'GeomSurfaceOfExtrusion'");
        return -1;
    }
}
...
//--------------------------------------------------------------------------
PyObject *SurfaceOfExtrusionPy::_repr()
{
...
//--------------------------------------------------------------------------
PyObject *SurfaceOfExtrusionPy::_getattr(const char *attr)			// __getattr__ function: note only need to handle new state
{
    try {
...
int SurfaceOfExtrusionPy::_setattr(const char *attr, PyObject *value) // __setattr__ function: note only need to handle new state
{
    try {
...
GeomSurfaceOfExtrusion *SurfaceOfExtrusionPy::getGeomSurfaceOfExtrusionPtr() const
{
