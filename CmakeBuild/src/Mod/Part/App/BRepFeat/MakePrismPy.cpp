...
PyMethodDef MakePrismPy::Methods[] = {
    {"init",
        reinterpret_cast<PyCFunction>(reinterpret_cast<void (*) (void)>( staticCallback_init )),
    ...
    {"perform",
        reinterpret_cast<PyCFunction>(reinterpret_cast<void (*) (void)>( staticCallback_perform )),
        METH_VARARGS|METH_KEYWORDS,
        ""
    },
    {"performUntilEnd",
