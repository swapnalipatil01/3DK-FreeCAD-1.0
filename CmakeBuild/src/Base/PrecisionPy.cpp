...
PyMethodDef PrecisionPy::Methods[] = {
    {"angular",
        reinterpret_cast<PyCFunction>(reinterpret_cast<void (*) (void)>( staticCallback_angular )),
        METH_VARARGS|METH_STATIC,
        "Returns the recommended precision value when checking the equality of two angles (given in radians)"
    },
    {"confusion",
        reinterpret_cast<PyCFunction>(reinterpret_cast<void (*) (void)>( staticCallback_confusion )),
        METH_VARARGS|METH_STATIC,
        "Returns the recommended precision value when checking coincidence of two points in real space"
    },
    {"squareConfusion",
        reinterpret_cast<PyCFunction>(reinterpret_cast<void (*) (void)>( staticCallback_squareConfusion )),
        METH_VARARGS|METH_STATIC,
        "Returns square of confusion"
    },
    {"intersection",
        reinterpret_cast<PyCFunction>(reinterpret_cast<void (*) (void)>( staticCallback_intersection )),
        METH_VARARGS|METH_STATIC,
        "Returns the precision value in real space, frequently used by intersection algorithms"
    },
    {"approximation",
        reinterpret_cast<PyCFunction>(reinterpret_cast<void (*) (void)>( staticCallback_approximation )),
        METH_VARARGS|METH_STATIC,
        "Returns the precision value in real space, frequently used by approximation algorithms"
    },
    {"parametric",
        reinterpret_cast<PyCFunction>(reinterpret_cast<void (*) (void)>( staticCallback_parametric )),
        METH_VARARGS|METH_STATIC,
        "Convert a real space precision to a parametric space precision"
    },
    {"isInfinite",
        reinterpret_cast<PyCFunction>(reinterpret_cast<void (*) (void)>( staticCallback_isInfinite )),
        METH_VARARGS|METH_STATIC,
        "Returns True if R may be considered as an infinite number"
    },
    {"isPositiveInfinite",
        reinterpret_cast<PyCFunction>(reinterpret_cast<void (*) (void)>( staticCallback_isPositiveInfinite )),
        METH_VARARGS|METH_STATIC,
        "Returns True if R may  be considered as a positive infinite number"
    },
    {"isNegativeInfinite",
        reinterpret_cast<PyCFunction>(reinterpret_cast<void (*) (void)>( staticCallback_isNegativeInfinite )),
        METH_VARARGS|METH_STATIC,
        "Returns True if R may  be considered as a negative infinite number"
    },
    {"infinite",
        reinterpret_cast<PyCFunction>(reinterpret_cast<void (*) (void)>( staticCallback_infinite )),
        METH_VARARGS|METH_STATIC,
...
PyObject *PrecisionPy::PyMake(struct _typeobject *, PyObject *, PyObject *)  // Python wrapper
{
