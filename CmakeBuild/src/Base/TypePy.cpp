...
PyTypeObject TypePy::Type = {
    ...
    "Base::BaseClass class and are not abstract classes.",           /*tp_doc */
    nullptr,                                          /*tp_traverse */
    nullptr,                                          /*tp_clear */
...
PyMethodDef TypePy::Methods[] = {
    {"fromName",
        reinterpret_cast<PyCFunction>(reinterpret_cast<void (*) (void)>( staticCallback_fromName )),
        METH_VARARGS|METH_STATIC,
        "fromName(name) -> Base.BaseType\n\nReturns a type object by name.\n\nname : str"
    },
    {"fromKey",
        reinterpret_cast<PyCFunction>(reinterpret_cast<void (*) (void)>( staticCallback_fromKey )),
        METH_VARARGS|METH_STATIC,
        "fromKey(key) -> Base.BaseType\n\nReturns a type id object by key.\n\nkey : int"
    },
    {"getNumTypes",
        reinterpret_cast<PyCFunction>(reinterpret_cast<void (*) (void)>( staticCallback_getNumTypes )),
        METH_VARARGS|METH_STATIC,
        "getNumTypes() -> int\n\nReturns the number of type ids created so far."
    },
    {"getBadType",
        reinterpret_cast<PyCFunction>(reinterpret_cast<void (*) (void)>( staticCallback_getBadType )),
        METH_VARARGS|METH_STATIC,
        "getBadType() -> Base.BaseType\n\nReturns an invalid type id."
    },
    {"getAllDerivedFrom",
        reinterpret_cast<PyCFunction>(reinterpret_cast<void (*) (void)>( staticCallback_getAllDerivedFrom )),
        METH_VARARGS|METH_STATIC,
    ...
    {"createInstanceByName",
        reinterpret_cast<PyCFunction>(reinterpret_cast<void (*) (void)>( staticCallback_createInstanceByName )),
        METH_VARARGS|METH_STATIC,
...
PyObject *TypePy::PyMake(struct _typeobject *, PyObject *, PyObject *)  // Python wrapper
{
...
{
    return std::string("<BaseType object>");
}
